...
{
    [Authorize]  //Filtro que permite que la WebApi UsersController puede ser consumida por user autorizados.
    ...
    public class UsersController : Controller
    {
        ...
        public IActionResult Authenticate([FromBody] UsersDto usersDto)   //Hacemos uso de los DTOs -> son los que se exponen a los clientes
        {
